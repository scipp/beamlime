...
def _channel_config(name: str) -> dict:
...
def _default_data_reduction_spec() -> dict:
    config = dict()
    # workflows
    config["workflows"] = [
...
def _default_data_stream_config() -> dict:
    ...
    config["application-specs"]["data-reduction"] = _default_data_reduction_spec()
...
def build_default_config():
    ...
    # Data Stream
    tpl["data-stream"] = _default_data_stream_config()
