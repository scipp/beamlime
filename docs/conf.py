...
sciline_domain_types_prefix = 'ess.livedata'
...
try:
    release = get_version("esslivedata")
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/scipp/esslivedata",
            "icon": "fa-brands fa-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/esslivedata/",
            "icon": "fa-brands fa-python",
            "type": "fontawesome",
        },
        {
            "name": "Conda",
            "url": "https://anaconda.org/conda-forge/esslivedata",
...
htmlhelp_basename = 'esslivedatadoc'
