...
Workflow = NewType("Workflow", sl.Pipeline)
...
def provide_workflow(
    ...
    return Workflow(
        sl.Pipeline(
            ...
            params={
                ConstantA: sc.scalar(0.0001, unit='m'),
                ConstantB: sc.scalar(1, unit='m'),
                ConstantC: sc.scalar(1, unit='1e-6m^2/s'),
                NumPixels: num_pixels,
                HistogramBinSize: histogram_binsize,
            },
        )
    )
