...
BenchmarkTargetFunctionName = NewType("BenchmarkTargetFunctionName", str)
...
@env_providers.provider
def provide_now() -> TimeStamp:
    from datetime import datetime

    return TimeStamp(datetime.utcnow().isoformat(timespec='seconds'))


@env_providers.provider
def provide_new_file_path(
    prefix_timestamp: TimeStamp, bm_root_dir: BenchmarkRootDir
